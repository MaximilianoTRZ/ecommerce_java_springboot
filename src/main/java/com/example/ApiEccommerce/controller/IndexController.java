...
@CrossOrigin(origins = "*")
@RequestMapping(path = "")
public class IndexController extends BaseControllerImpl<Articulo, ArticuloServiceImpl>{


    @GetMapping("/")  //si quisiera que dos direcciones me llevaran a la misma pagina pondria {"/dir1","/dir2"}
    public String index(Model model) throws Exception { //EL NOMBRE DEL METODO ES SOLO REPRESENTATIVO, NO SE UTILIZA
        try {
